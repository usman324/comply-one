            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title mb-0 float-start">Add {{ $title }}s </h5>
                                ...
                                <div class="card-body">
                                    <div id="questionsContainer" class="questions-list">
                                        ...
                                        <div class="text-center text-muted py-4" id="noQuestionsMsg">
                                            ...
                                            <p class="mt-2">No questions added yet. Click "Add Question" to get started.
                                            </p>
                                        </div>
                                    </div>
                                </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            function addOption($questionItem) {
                ...
                const $optionHtml = $(`
                <div class="input-group mb-2">
                    <input type="text" class="form-control form-control-sm option-input" placeholder="Option ${optionCount}" />
                    <button class="btn btn-outline-danger remove-option" type="button">
                        <i class="ri-close-line"></i>
                    </button>
                </div>
