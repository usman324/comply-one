                                    ...
                                    <div class="tab-content">
                                            ...
                                            <div class="row g-3">
                                                <div class="col-md-12">
                                                    ...
                                                    <input type="text" class="form-control" id="workspace_name"
                                                        name="workspace_name" placeholder="Enter workspace name" required>
                                                        ...
                                                        @if($question->options)
                                                            ...
                                                            <div class="form-check">
                                                                <input class="form-check-input"
                                                                    ...
                                                                    value="{{ $option }}"
                                                                    {{ $question->is_required ? 'required' : '' }}>
                                                                <label class="form-check-label" for="question-{{ $question->id }}-{{ $optIndex }}">
                                                                    {{ $option }}
                                                                </label>
                                                            </div>
                                                            @endforeach
                                        ...
                                        <div class="tab-pane fade" id="step-finish" role="tabpanel"
                                            ...
                                            <div class="d-flex align-items-start gap-3 mt-4">
                                                ...
                                                <button type="button" id="submit-wizard" class="btn btn-primary btn-label right ms-auto">
                                    ...
                                    <div class="card-body">
                                        <div class="mb-3">
                                            <div class="d-flex justify-content-between mb-1">
                                                ...
                                                <span id="progress-percentage" class="text-primary fw-semibold">0%</span>
                                            </div>
                                        ...
                                        <div class="alert alert-info mt-4" role="alert">
                                            <strong>Tip:</strong> All fields marked with <span class="text-danger">*</span> are required.
                                        </div>
                                    </div>
                                </div>
                            </div>
...
(function() {
    ...
    function populateReview() {
        ...
        html += `<dt class="col-sm-4">Workspace Name:</dt><dd class="col-sm-8">${workspaceName || 'Not provided'}</dd>`;
        html += `<dt class="col-sm-4">Description:</dt><dd class="col-sm-8">${workspaceDesc || 'Not provided'}</dd>`;
        html += `<dt class="col-sm-4">Type:</dt><dd class="col-sm-8">${workspaceType || 'Not selected'}</dd>`;
        html += `<dt class="col-sm-4">Status:</dt><dd class="col-sm-8"><span class="badge bg-${workspaceStatus === 'active' ? 'success' : 'secondary'}">${workspaceStatus}</span></dd>`;
        ...
        questionElements.forEach(section => {
            ...
            const sectionTitle = document.querySelector(`[data-bs-target="#step-${sectionId}"]`)?.textContent.trim() || sectionId;
