                                    ...
                                    <div class="px-lg-4">
                                        <div class="tab-content">
                                            ...
                                            <div class="tab-pane fade show active" id="step-workspace" role="tabpanel"
                                                ...
                                                <div class="row g-3">
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <textarea class="form-control" id="workspace_description" name="description" rows="3"
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <select class="form-select" id="workspace_type" name="type">
                                                            ...
                                                            <option value="personal"
                                                                {{ old('type', $record->type) == 'personal' ? 'selected' : '' }}>
                                                                Personal</option>
                                                            <option value="team"
                                                                {{ old('type', $record->type) == 'team' ? 'selected' : '' }}>
                                                                Team</option>
                                                            <option value="enterprise"
                                                                {{ old('type', $record->type) == 'enterprise' ? 'selected' : '' }}>
                                                                Enterprise</option>
                                                        </select>
                                                    </div>
                                                    ...
                                                    <div class="row g-3" id="questions-{{ $section['slug'] }}">
                                                        @foreach ($section['questions'] as $question)
                                                            <div class="col-md-12">
                                                                ...
                                                                @php
                                                                    $existingAnswer =
                                                                        $existingResponses[$question->id] ?? null;
                                                                @endphp
                                                                ...
                                                                @elseif($question->type === 'textarea')
                                                                    <textarea class="form-control" id="question-{{ $question->id }}" name="answers[{{ $question->id }}]"
                                                                        rows="4" {{ $question->is_required ? 'required' : '' }}>{{ old('answers.' . $question->id, $existingAnswer) }}</textarea>
                                                                ...
                                                                @elseif($question->type === 'checkbox')
                                                                    @php
                                                                        $existingAnswerArray = is_array($existingAnswer)
                                                                            ? $existingAnswer
                                                                            : [];
                                                                    @endphp
                                                                    @foreach ($question->options as $optionIndex => $option)
                                            ...
                                            <div class="tab-pane fade" id="step-finish" role="tabpanel"
                                                ...
                                                <div>
                                                    <h5>Review & Submit</h5>
                                                    <p class="text-muted">Please review your information before updating
                                                    </p>
                                                </div>
    ...
    <script>
        (function() {
            ...
            function updateProgress() {
                const activeTabIndex = Array.from(document.querySelectorAll('.nav-link')).findIndex(tab => tab.classList
                    .contains('active'));
            ...
            function populateReviewSection() {
                ...
                html +=
                    `<dt class="col-sm-5">Workspace Name</dt><dd class="col-sm-7">${document.getElementById('workspace_name').value || 'Not provided'}</dd>`;
                html +=
                    `<dt class="col-sm-5">Description</dt><dd class="col-sm-7">${document.getElementById('workspace_description').value || 'Not provided'}</dd>`;
                html +=
                    `<dt class="col-sm-5">Type</dt><dd class="col-sm-7">${document.getElementById('workspace_type').value || 'Not provided'}</dd>`;
                html +=
                    `<dt class="col-sm-5">Status</dt><dd class="col-sm-7">${document.getElementById('workspace_status').value || 'Not provided'}</dd>`;
                html += '</dl></div></div>';
