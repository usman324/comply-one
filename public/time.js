...
var FullCalendar = (function (e) {
    ...
    function C(e, t, n, r, o) {
        ...
        e: if ("style" === t)
            ...
            (i = t !== (t = t.replace(/Capture$/, ""))),
                ...
                (e.l[t + i] = n),
                n
                    ? r || e.addEventListener(t, i ? R : D, i)
                    : e.removeEventListener(t, i ? R : D, i);
            ...
            if (
                ...
                (v = n.__k[c] =
                    null == (v = t[c]) || "boolean" == typeof v
                        ...
                        : "string" == typeof v ||
                          "number" == typeof v ||
                          "bigint" == typeof v
                        ? S(null, v, null, null, v)
                        : Array.isArray(v)
                        ? S(E, { children: v }, null, null, null)
                        : v.__b > 0
                        ? S(v.type, v.props, v.key, v.ref ? v.ref : null, v.__v)
                        : v)
            ) {
                if (
                    ((v.__ = n),
                ...
                A(e, v, (p = p || f), o, i, a, s, l, u),
                    ...
                    null != g
                        ...
                        : l && p.__e == l && l.parentNode != e && (l = T(p));
            }
        for (n.__e = m, c = C; c--; )
            null != b[c] &&
            ...
            l ||
                ("value" in h &&
                    ...
                    (g !== e.value ||
                        ("progress" === v && !g) ||
                        ("option" === v && g !== p.value)) &&
                    C(e, "value", g, p.value, !1),
                "checked" in h &&
                    void 0 !== (g = h.checked) &&
                    g !== e.checked &&
                    C(e, "checked", g, p.checked, !1));
        }
        return e;
    }
    function U(e, t, n) {
    ...
    function B(e, t, n) {
        ...
        if (
            ...
            (r = e.ref) &&
                ((r.current && r.current !== e.__e) || U(r, null, t)),
            null != (r = e.__c))
        ) {
    ...
    (a.__b = function (e) {
        ...
        (a.diffed = function (e) {
            ...
            t &&
                t.__H &&
                (t.__H.__h.length &&
                    ((1 !== q.push(t) && j === a.requestAnimationFrame) ||
                        ((j = a.requestAnimationFrame) || te)(Q)),
    ...
    function ne(e) {
        var t = F,
            n = e.__c;
        "function" == typeof n && ((e.__c = void 0), n()), (F = t);
    }
    function re(e) {
        var t = F;
        (e.__c = e.__()), (F = t);
    ...
    (a.unmount = function (e) {
        ...
        (de.prototype.render = function (e, t) {
            ...
            return (
                o && (o.__h = null), [y(E, null, t.__a ? null : e.children), o]
            );
        });
        ...
        (t.componentWillUnmount = function () {
            ...
            e.__v
                ? (t.l ||
                  ...
                  V(y(ve, { context: t.context }, e.__v), t.l))
    ...
    function ot(e, t, n) {
        var r, o;
        for (r = 0; r < n.length; r += 1) if ((o = it(e, t, n[r]))) return o;
        return 0;
    }
    function it(e, t, n) {
        return n.func
            ? n.func(e, t)
            : at(e[n.field], t[n.field]) * (n.order || 1);
    }
    function at(e, t) {
        return e || t
            ? null == t
    ...
    function Wt(e, t) {
        if (e === t) return !0;
        for (var n in e) if (It.call(e, n) && !(n in t)) return !1;
        for (var n in t) if (It.call(t, n) && e[n] !== t[n]) return !1;
        return !0;
    }
    function Lt(e, t) {
        var n = [];
        for (var r in e) It.call(e, r) && (r in t || n.push(r));
        for (var r in t) It.call(t, r) && e[r] !== t[r] && n.push(r);
        return n;
    }
    function Ut(e, t, n) {
    ...
    function tn(e, t) {
        for (var n = null, r = 0; r < Gt.length; r += 1) {
            ...
            if (t[o]) {
                var i = e[o] / t[o];
                if (!ct(i) || (null !== n && n !== i)) return null;
                n = i;
    ...
    var hn = {
        ...
        bn = (function () {
            function e(e) {
                ...
                for (var o in e)
                    o in hn
                        ? ((n[o] = e[o]), (r = Math.max(hn[o], r)))
                        : ((t[o] = e[o]), o in vn && (r = Math.max(vn[o], r)));
    ...
    function Ln(e, t, n, r) {
        for (
            var o = { defs: {}, instances: {} }, i = tr(n), a = 0, s = e;
            a < s.length;
            a++
        ) {
    ...
    var Kn = {
        ...
        $n = { start: Wn, end: Wn, date: Wn, allDay: Boolean },
        Jn = r(r(r({}, Kn), $n), { extendedProps: Wn });
    ...
    function or(e, t) {
        ...
        return (
            e.start && ((n = bt(e.start)), r && r <= n && (r = ht(n, 1))),
            { start: n, end: r }
        );
    }
    function ir(e) {
    ...
    function ar(e, t, n, r) {
        return "year" === r
            ? qt(n.diffWholeYears(e, t), "year")
            : "month" === r
            ? qt(n.diffWholeMonths(e, t), "month")
            : yt(e, t);
    }
    function sr(e, t) {
        var n,
    ...
    function hr(e, t, n, r) {
        var o = {},
            ...
            u = yr(e.defs, t);
        for (var c in e.defs) {
            "inverse-background" === (f = u[(E = e.defs[c]).defId]).display &&
                (E.groupId
                    ? ((o[E.groupId] = []), a[E.groupId] || (a[E.groupId] = E))
                    : (i[c] = []));
        }
    ...
    var Mr = { start: Wn, end: Wn, allDay: Boolean };
    function Ir(e, t, n) {
        var o = (function (e, t) {
                var n = An(e, Mr),
                    o = n.refined,
    ...
    function Nr(e, t, n) {
        return r(r({}, Hr(e, t, n)), { timeZone: t.timeZone });
    }
    function Hr(e, t, n) {
        return {
    ...
    function Wr(e, t) {
        ...
        return (
            r(
                ...
                ((n = e),
                (o = t.dateEnv),
                r(r({}, Hr(n.range, o, n.allDay)), { allDay: n.allDay }))
            ),
            i
        );
    }
    ...
    function zr(e, t, n, o, i) {
        ...
        return (
            ...
            u.range.end < u.range.start &&
                (u.range.end = Lr(t.allDay, u.range.start, i)),
            u
        );
    }
    var Vr = (function () {
            ...
            return (
                    ...
                    if (e instanceof Zr) {
                        ...
                        return (
                            this.getCurrentData().eventStore.defs[n.defId] ||
                                (this.dispatch({
                                    type: "ADD_EVENTS",
                                    eventStore: Un({ def: n, instance: r }),
                                }),
                ...
                (e.prototype.getEventById = function (e) {
                    ...
                    for (var i in ((e = String(e)), r)) {
                        var a = r[i];
                        if (a.publicId === e) {
                            if (a.recurringDef) return new Zr(t, a, null);
                            for (var s in o) {
                                var l = o[s];
                                if (l.defId === a.defId) return new Zr(t, a, l);
                            }
                        }
                    }
                    return null;
            ...
            return (
                ...
                (e.prototype.timestampToMarker = function (e) {
                    return "local" === this.timeZone
                        ...
                        ? _t(this.namedTimeZoneImpl.timestampToArray(e))
                        : new Date(e);
                }),
                (e.prototype.offsetForMarker = function (e) {
                    return "local" === this.timeZone
                        ? -wt(Tt(e)).getTimezoneOffset()
                        : "UTC" === this.timeZone
                        ? 0
    ...
    function uo(e) {
        ...
        return new no(
            r(r({ timeZone: kn.timeZone, calendarSystem: "gregory" }, e), {
                locale: t,
            })
        );
    }
            ...
            return (
                (e.prototype.splitProps = function (e) {
                    var t = this,
                        ...
                        u = {};
                    for (var c in ((this.eventUiBuilders = Ht(
                        n,
                        function (e, n) {
    ...
    var _o = _n({ year: "numeric", month: "long", day: "numeric" }),
        xo = _n({ week: "long" });
    function ko(e, t, n, o) {
        ...
        if (a.navLinks) {
            ...
            return r(
                { title: lt(a.navLinkHint, [l, u], l), "data-navlink": "" },
                o ? Ye(c) : { onClick: c }
            );
        }
        return { "aria-label": l };
    ...
    (oi.prototype.propEquality = {}), (oi.prototype.stateEquality = {});
    var ii = (function (e) {
        function t() {
            return (null !== e && e.apply(this, arguments)) || this;
        }
        return n(t, e), (t.contextType = ni), t;
    })(oi);
    function ai(e) {
    ...
    var mi = (function (e) {
            ...
            return (
                ...
                (t.prototype.getInnerContent = function () {
                    ...
                    return (
                        void 0 === t && (t = bi(e.defaultContent, e.hookProps)),
                        null == t ? null : t
                    );
                }),
        ...
        yi = (function (e) {
            function t() {
                ...
                return (
                    (t.handleRootEl = function (e) {
                        (t.rootEl = e), t.props.elRef && li(t.props.elRef, e);
                    }),
                    t
                );
            }
    ...
    function wi(e, t, n, o) {
        ...
        return Ht(
            (function (e, t) {
                var n,
                    r = {};
                for (n in e) fi(n, r, e, t);
                for (n in t) fi(n, r, e, t);
                return r;
            })(i, a),
            function (e) {
                return (function (e, t, n, o, i) {
                    ...
                    return {
                        ...
                        buttonTextDefault:
                            p(i) || e.defaults.buttonText || p(kn) || e.type,
                        buttonTitleOverride:
                            f(o) || f(n) || e.overrides.buttonHint,
                        buttonTitleDefault:
                            f(i) || e.defaults.buttonHint || f(kn),
                    };
                })(e, a, t, n, o);
            }
        );
    ...
    var _i = (function () {
        ...
        return (
            ...
            (e.prototype.buildCurrentRangeInfo = function (e, t) {
                ...
                return (
                    r.duration
                        ...
                        : ((i = nn((o = this.getFallbackDuration())).unit),
                          (a = this.buildRangeFromDuration(e, t, o, i))),
            ...
            (e.prototype.adjustActiveRange = function (e) {
                ...
                return (
                    r &&
                        ($t(o) < 0 && ((a = bt(a)), (a = n.add(a, o))),
                        $t(i) > 1 &&
                            ((s = ht((s = bt(s)), -1)), (s = n.add(s, i)))),
                    { start: a, end: s }
                );
            }),
            ...
            (e.prototype.buildRangeFromDayCount = function (e, t, n) {
                ...
                do {
                    (r = ht(r, 1)), this.isHiddenDay(r) || (s += 1);
                } while (s < n);
    ...
    function ki(e, t, n, o) {
        ...
        switch (t.type) {
            ...
            case "FETCH_EVENT_SOURCES":
                return Ni(
                    e,
                    t.sourceIds ? Ot(t.sourceIds) : Oi(e, o),
                    s,
                    t.isRefetch || !1,
                    o
                );
            ...
            case "RECEIVE_EVENTS":
                return (function (e, t, n, r, o, i) {
                    if (t && n === t.latestFetchId) {
                        ...
                        return r && (a = Vt(a, r, i)), Vn(Ui(e, t.sourceId), a);
                    }
                    return e;
            ...
            eventSourceDefs: [
                {
                    ...
                    fetch: function (e, t, n) {
                        ...
                        Uo(
                            e.eventSource.meta.bind(null, Nr(e.range, r)),
                            function (e) {
                                t({ rawEvents: e });
                            },
                            n
            ...
            recurringTypes: [
                {
                    ...
                    expand: function (e, t, n) {
                        var r = ur(t, { start: e.startRecur, end: e.endRecur });
                        return r
                            ? (function (e, t, n, r) {
                                  var o = e ? Ot(e) : null,
                                      i = bt(n.start),
        ...
        ci({
            ...
            propSetHandlers: {
                dateProfile: function (e, t) {
                    t.emitter.trigger(
                        "datesSet",
                        r(r({}, Nr(e.activeRange, t.dateEnv)), {
                            view: t.viewApi,
                        })
                    );
                },
    ...
    var ea = (function () {
        function e(e) {
            ...
            (this.computeOptionsData = cn(this._computeOptionsData)),
                (this.computeCurrentViewData = cn(
            ...
            for (
                var v = xi(o.calendarOptions, d, p),
                    g = {
        ...
        return (
            ...
            (e.prototype._handleAction = function (e) {
                ...
                for (
                    var f = ki(o.eventSources, e, p, c),
                        h = Wi(o.eventStore, e, f, p, c),
                        v =
                            (Mi(f) &&
            ...
            (e.prototype.updateData = function () {
                var e,
                    ...
                    a = this.state,
                    s = this.data,
                    l = this.computeOptionsData(
                        i.optionOverrides,
                        a.dynamicOptionOverrides,
                        i.calendarApi
                    ),
                    u = this.computeCurrentViewData(
                        a.currentViewType,
                        l,
                        i.optionOverrides,
                        a.dynamicOptionOverrides
                    ...
                    f = l.calendarOptions;
                if (p && p !== f)
                    for (var h in (p.timeZone !== f.timeZone &&
                        ((a.eventSources = c.eventSources =
                            ((e = c.eventSources),
                            (t = a.dateProfile),
                            (n = c),
                            (o = t ? t.activeRange : null),
                            Ni(e, Oi(e, n), o, !0, n))),
                        (a.eventStore = c.eventStore =
                            (function (e, t, n) {
                                var o = e.defs,
            ...
            (e.prototype.processRawCalendarOptions = function (e, t) {
                var n = On([kn, e, t]),
                    ...
                    c = (this.currentCalendarOptionsRefiners = r(
                        r(r(r(r({}, xn), Mn), In), u.listenerRefiners),
                        u.optionRefiners
                    )),
                    d = {},
                    p = On([kn, l, e, t]),
                ...
                for (var m in p)
                    "plugins" !== m &&
                        (p[m] === h[m] || (Pn[m] && m in h && Pn[m](h[m], p[m]))
                            ? (f[m] = v[m])
                            : c[m]
                            ? ((f[m] = c[m](p[m])), (g = !0))
                            : (d[m] = h[m]));
            ...
            (e.prototype.processRawViewOptions = function (e, t, n, o, i) {
                var a = On([kn, e.optionDefaults, n, o, e.optionOverrides, i]),
                    s = r(
                        r(r(r(r(r({}, xn), Mn), In), Hn), t.listenerRefiners),
                        t.optionRefiners
                    ),
                    l = {},
                    ...
                    p = {};
                for (var f in a)
                    a[f] === u[f] || (Pn[f] && Pn[f](a[f], u[f]))
                        ? (l[f] = c[f])
                        : (a[f] === this.currentCalendarOptionsInput[f] ||
                          (Pn[f] &&
                              Pn[f](a[f], this.currentCalendarOptionsInput[f]))
            ...
            return (
                ...
                (e.prototype.insertEntryAt = function (e, t) {
                    var n = this.entriesByLevel,
                        r = this.levelCoords;
                    -1 === t.lateral
                        ? (Sa(r, t.level, t.levelCoord), Sa(n, t.level, [e]))
                        : Sa(n[t.level], t.lateral, e),
                ...
                (e.prototype.findInsertion = function (e) {
                    ...
                    var S = 0;
                    if (c) for (S = l + 1; S < a && n[S] < s; ) S += 1;
                    var E = -1;
                    return (
                        S < a &&
                            n[S] === s &&
                            (E = Ea(r[S], e.span.end, ha)[0]),
                        {
                            touchingLevel: l,
                            touchingLateral: u,
                            touchingEntry: c,
    ...
    var Ra = {},
        ...
        Ta = {},
        _a = { startTime: qt, duration: qt, create: Boolean, sourceId: String };
    function xa(e) {
        var t = An(e, _a),
            n = t.refined,
            r = t.extra;
    ...
    var za = (function (e) {
        ...
        Ga = (function (e) {
            function t(t, n) {
                ...
                return (
                    (r.initialNowDate = qr(n.options.now, n.dateEnv)),
            ...
            return (
                ...
                (t.prototype.computeTiming = function () {
                    ...
                    return (
                        (i = Math.min(864e5, i)),
                        {
                            currentState: { nowDate: r, todayRange: ja(r) },
                            nextState: { nowDate: o, todayRange: ja(o) },
                            waitMs: i,
                        }
                    );
                }),
    ...
    function ja(e) {
        var t = bt(e);
        return { start: t, end: ht(t, 1) };
    }
    var qa = (function (e) {
        function t() {
            var t = (null !== e && e.apply(this, arguments)) || this;
            return (t.createDayHeaderFormatter = cn(Ya)), t;
        }
        return (
            n(t, e),
            (t.prototype.render = function () {
                ...
                return Yo(Ga, { unit: "day" }, function (e, t) {
                    return Yo(
                        "tr",
                        { role: "row" },
                        i && i("day"),
            ...
            return (
                ...
                (e.prototype.sliceEventRange = function (e, t) {
                    ...
                    this.forceDayIfListItem &&
                        ...
                        (n = { start: n.start, end: ht(n.start, 1) });
                    for (
    ...
    function Ja(e, t, n) {
        ...
        for (var o in r) if (!pr(t.validRange, r[o].range)) return !1;
        return es({ eventDrag: e }, n);
    }
    function Qa(e, t, n) {
        return !!pr(t.validRange, e.range) && es({ dateSelection: e }, n);
    }
    function es(e, t) {
            ...
            !(
                ...
                !(function (e, t, n, o) {
                    ...
                    for (var m in u) {
                        ...
                        for (
                            var T = i.eventStore, _ = 0, x = E.allows;
                            _ < x.length;
                            _++
                        ) {
                            var k = x[_],
    ...
    function ns(e, t, n, r, o) {
        for (var i = 0, a = e; i < a.length; i++) {
            if (!is(rs(a[i], t, n, r, o), t)) return !1;
        }
        return !0;
    }
        ...
        ss = (function (e) {
            ...
            return (
                ...
                (t.prototype.needsXScrolling = function () {
                    if (as.test(this.props.overflowX)) return !1;
                    for (
                        var e = this.el,
                            t =
                ...
                (t.prototype.needsYScrolling = function () {
                    if (as.test(this.props.overflowY)) return !1;
                    for (
                        var e = this.el,
                            t =
        ...
        return (
            ...
            (t.prototype.render = function () {
                ...
                return Yo(
                    ...
                    Boolean(!v && p.length) &&
                        Yo.apply(void 0, o(["thead", g], p)),
                    Boolean(!v && f.length) &&
                        Yo.apply(void 0, o(["tbody", g], f)),
                    Boolean(!v && h.length) &&
                        Yo.apply(void 0, o(["tfoot", g], h)),
                    v && Yo.apply(void 0, o(o(o(["tbody", g], p), f), h))
                );
            }),
            (t.prototype.renderSection = function (e, t, n) {
                return "outerContent" in e
                    ? Yo(Ko, { key: e.key }, e.outerContent)
                    : Yo(
                          "tr",
                          {
                              key: e.key,
            ...
            (t.prototype.computeShrinkWidth = function () {
                return gs(this.props.cols)
                    ? us(this.scrollerElRefs.getAll())
                    : 0;
            }),
    ...
    var Ms = (function (e) {
        function t() {
            var t = (null !== e && e.apply(this, arguments)) || this;
            return (
                (t.refineHookProps = dn(ks)), (t.normalizeClassNames = Si()), t
            );
        }
        return (
            n(t, e),
            (t.prototype.render = function () {
                var e = this.props,
                    ...
                    o = wo(r, t.theme).concat(
                        r.isDisabled
                            ? []
                            : this.normalizeClassNames(n.dayCellClassNames, r)
                    ),
                    i = r.isDisabled ? {} : { "data-date": on(e.date) };
                return Yo(
                    yi,
                    {
                        hookProps: r,
    ...
    var As = (function (e) {
        ...
        Ls = (function (e) {
            function t() {
                ...
                return (
                    (t.linkElRef = Xo()),
                    (t.state = { isPopoverOpen: !1, popoverId: Ve() }),
    ...
    function Bs(e) {
        if (e.allDayDate)
            return { start: e.allDayDate, end: ht(e.allDayDate, 1) };
        var t,
            n = e.hiddenSegs;
        return {
            start: zs(n),
            ...
            return (
                (e.prototype.destroy = function () {
                    this.containerEl.removeEventListener(
                        ...
                        (qs -= 1) ||
                            window.removeEventListener("touchmove", Xs, {
                                passive: !1,
                            });
                }),
    ...
    function il(e, t) {
        return (
            (!e && !t) ||
            (Boolean(e) === Boolean(t) && Pr(e.dateSpan, t.dateSpan))
        );
    }
    function al(e, t) {
        for (
            ...
            function t(t) {
                ...
                (n.dragSelection = null),
                    ...
                    (n.handlePointerUp = function (e) {
                        n.dragSelection &&
                            (Ar(n.dragSelection, e, n.component.context),
                            (n.dragSelection = null));
                    });
        ...
        function t(t) {
            ...
            (n.draggingSegEl = null),
                ...
                (n.handleHitUpdate = function (e, t, r) {
                    ...
                    l &&
                        ((u = Ur(i, o.getCurrentData().eventUiBases, l, o)),
                        (d.mutatedEvents = u),
                        Ja(d, e.dateProfile, o) ||
                            ((c = !0),
                            (l = null),
                            (u = null),
            ...
            return (
                (e.prototype.buildDragMeta = function (e) {
                    return "object" == typeof this.suppliedDragMeta
                        ? xa(this.suppliedDragMeta)
                        : "function" == typeof this.suppliedDragMeta
                        ? xa(this.suppliedDragMeta(e))
                        : xa(
                              (t = (function (e, t) {
            ...
            return (
                ...
                (t.prototype.renderSimpleLayout = function (e, t) {
                    ...
                    return (
                        ...
                        Yo(Ci, { viewSpec: r.viewSpec }, function (e, t) {
                            return Yo(
                                "div",
                                {
                                    ref: e,
                    ...
                    return (
                        ...
                        l &&
                            u.push({
                                ...
                                key: "footer",
                                isSticky: !0,
                                chunks: [{ key: "main", content: Ss }],
                            }),
                        Yo(Ci, { viewSpec: a.viewSpec }, function (e, t) {
                            return Yo(
                                "div",
                                {
                                    ref: e,
    ...
    var Pl = _n({ week: "narrow" }),
        Nl = (function (e) {
            function t() {
                var t = (null !== e && e.apply(this, arguments)) || this;
                return (
                    (t.rootElRef = Xo()),
                    (t.state = { dayNumberId: Ve() }),
                    (t.handleRootEl = function (e) {
                        li(t.rootElRef, e), li(t.props.elRef, e);
                    }),
                    t
                );
            }
        ...
        for (var l = [], u = [], c = 0; c < e.length; c += 1) {
            ...
            null != d
                ? l.push({
                      index: c,
                      thickness: d,
                      span: { start: w.firstCol, end: w.lastCol + 1 },
                  })
                : u.push(w);
        }
        for (
    ...
    function Ol(e, t, n, o) {
        ...
        var i = e.eventRange,
            a = i.range,
            s = ur(a, { start: o[t].date, end: ht(o[n - 1].date, 1) });
        return r(r({}, e), {
            firstCol: t,
            lastCol: n - 1,
            eventRange: {
    ...
    Wl.addStateEquality({ eventInstanceHeights: Wt });
    var Ll = (function (e) {
        function t() {
            var t = (null !== e && e.apply(this, arguments)) || this;
            return (
                (t.splitBusinessHourSegs = cn(El)),
    ...
    var Bl = (function (e) {
        ...
        zl = (function (e) {
            function t() {
                var t = (null !== e && e.apply(this, arguments)) || this;
                return (t.slicer = new Bl()), (t.tableRef = Xo()), t;
            }
            return (
                n(t, e),
                (t.prototype.render = function () {
            ...
            var r = n.dateEnv,
                ...
                a =
                    null == o.slotLabelFormat
                        ...
                        ? _n(o.slotLabelFormat[0])
                        : _n(o.slotLabelFormat),
                s = {
                    level: 0,
                    time: e.time,
                ...
                return (
                    ...
                    (t.renderHeadAxis = function (e, n) {
                        ...
                        var o = t.context.options,
                            ...
                            a =
                                1 === mt(i.start, i.end)
                                    ? ko(t.context, i.start, "week")
                                    : {};
                        return o.weekNumbers && "day" === e
                            ? Yo(
                                  Hs,
                                  { date: i.start, defaultFormat: Kl },
                                  function (e, t, o, i) {
                                      return Yo(
                                          "th",
                                          {
    ...
    var Ql = (function () {
            ...
            return (
                ...
                (e.prototype.computeTimeTop = function (e) {
                    var t,
                        ...
                        i = r.els.length,
                        a =
                            (e.milliseconds - en(o.slotMinTime)) /
                            en(this.slotDuration);
                    return (
                        (a = Math.max(0, a)),
                        (a = Math.min(i, a)),
                        (t = Math.floor(a)),
        ...
        tu = (function (e) {
            function t() {
                var t = (null !== e && e.apply(this, arguments)) || this;
                return (t.rootElRef = Xo()), (t.slatElRefs = new ls()), t;
            }
            return (
                n(t, e),
                (t.prototype.render = function () {
    ...
    function su(e, t) {
        ...
        for (
            ...
            a.push(t(n, i)), (i += 1);
        return a.sort(lu), [a.map(uu), a[0][1]];
    }
    function lu(e, t) {
        return t[1] - e[1];
    }
    ...
    var pu = _n({ hour: "numeric", minute: "2-digit", meridiem: !1 }),
        fu = (function (e) {
            function t() {
                return (null !== e && e.apply(this, arguments)) || this;
            }
        ...
        vu = (function (e) {
            function t() {
                var t = (null !== e && e.apply(this, arguments)) || this;
                return (t.sortEventSegs = cn(Er)), t;
            }
            return (
                n(t, e),
                (t.prototype.render = function () {
    ...
    var Tu = (function (e) {
        function t() {
            var t = (null !== e && e.apply(this, arguments)) || this;
            return (
                (t.buildTimeColsModel = cn(_u)), (t.buildSlatMetas = cn(wu)), t
            );
        }
        return (
            n(t, e),
    ...
    var Iu = _n({ hour: "numeric", minute: "2-digit", meridiem: "short" }),
        Pu = (function (e) {
            function t() {
                return (null !== e && e.apply(this, arguments)) || this;
            }
    ...
    var Hu = (function (e) {
        ...
        return (
            ...
            (t.prototype.renderSegList = function (e, t) {
                ...
                return Yo(Ga, { unit: "day" }, function (e, n) {
                    ...
                    return Yo(
                        ...
                        Yo(
                            ...
                            Yo(
                                "tr",
                                null,
                                Yo("th", { scope: "col", id: s }, i.timeHint),
                                Yo("th", { scope: "col", "aria-hidden": !0 }),
                                Yo("th", { scope: "col", id: l }, i.eventHint)
                            )
                        ),
                        Yo("tbody", null, a)
                    );
    ...
    function Au(e) {
        for (
            ...
            r.push(t), o.push({ start: t, end: ht(t, 1) }), (t = ht(t, 1));
    ...
    var Bu = ci({ themeClasses: { bootstrap: Uu } }),
        zu = (function (e) {
            function t() {
                return (null !== e && e.apply(this, arguments)) || this;
            }
    ...
    var Vu = ci({ themeClasses: { bootstrap5: zu } }),
            ...
            eventSourceDefs: [
                {
                    ...
                    fetch: function (e, t, n) {
                        var o = e.context,
                            ...
                            l =
                                s.googleCalendarApiKey ||
                                a.googleCalendarApiKey;
                        if (l) {
                            var u = (function (e) {
    ...
    var Zu,
                    ...
                    var t = e.options.schedulerLicenseKey,
                        n =
                            "undefined" != typeof window
                                ...
                                : "";
                    if (
                        !/\w+:\/\/fullcalendar\.io\/|\/examples\/[\w-]+\.html$/.test(
                            n
                        )
                    ) {
                        var r = (function (e) {
                            if (-1 !== qu.indexOf(e)) return "valid";
                            var t = (e || "").match(/^(\d+)-fcs-(\d+)$/);
                            if (t && 10 === t[1].length) {
                                var n = new Date(1e3 * parseInt(t[2], 10)),
                                    r = new Date(
                                        Ta.mockSchedulerReleaseDate || ju
                                    );
                                if (xt(r))
                                    return ht(r, -372) < n
                                        ? "valid"
                        ...
                        if ("valid" !== r)
                            return Yo(
                                "div",
                                { className: "fc-license-message", style: Yu },
                                "outdated" === r
                                    ? Yo(
                                          Ko,
                                          null,
        ...
        Ku = "wheel mousewheel DomMouseScroll MozMousePixelScroll".split(" "),
        $u = (function () {
            function e(e) {
                var t = this;
                (this.el = e),
                    ...
                    (this.wheelWaiter = new $i(
                        this._handleWheelWaited.bind(this)
                    )),
                    (this.scrollWaiter = new $i(
                        this._handleScrollWaited.bind(this)
                    )),
                        ...
                        !(function () {
                            null == tc &&
                                (tc = (function () {
                                    ...
                                    return Ie(e), "sticky" === t;
                                })());
                            return tc;
                        })() ||
                        (nc && t)),
                    this.usingRelative &&
                        ((this.listener = new $u(e)),
                    ...
                    for (
                        ...
                        "start" === d
                            ...
                            "sticky" !== c.position &&
                                (p = go(
                                    u,
                                    -r.left - (parseFloat(c.left) || 0),
                                    -r.top - (parseFloat(c.top) || 0)
                                )),
                            o.push({
                                parentBound: l,
                                naturalBound: p,
    ...
    var oc = (function (e) {
            function t() {
                ...
                return (
                    ...
                    (t.handleScroller = function (e) {
                        (t.scroller = e), li(t.props.scrollerRef, e);
                    }),
                    (t.handleSizing = function () {
                        var e = t.props;
                        "scroll-hidden" === e.overflowY &&
                            t.setState({
                                yScrollbarWidth:
                                    t.scroller.getYScrollbarWidth(),
                            }),
                            "scroll-hidden" === e.overflowX &&
                                t.setState({
                                    xScrollbarWidth:
                                        t.scroller.getXScrollbarWidth(),
                                });
                    }),
                    t
                );
            ...
            return (
                ...
                (t.prototype.render = function () {
                    var e = this,
                        ...
                        a = 0;
                    return (
                        "scroll-hidden" === t.overflowX &&
                            (a = n.xScrollbarWidth),
                        "scroll-hidden" === t.overflowY &&
                            null != n.yScrollbarWidth &&
                            (r
                                ? (o = n.yScrollbarWidth)
                                : (i = n.yScrollbarWidth)),
                        Yo(
        ...
        ic = (function () {
            ...
            return (
                (e.prototype.destroy = function () {
                    for (
                        var e = 0, t = this.scrollListeners;
                        e < t.length;
                        e++
                    ) {
                        t[e].destroy();
                ...
                (e.prototype.assignMaster = function (e) {
                    this.masterEl = e;
                    for (
                        var t = 0, n = this.scrollListeners;
                        t < n.length;
                        t++
                    ) {
                        var r = n[t];
        ...
        ac = (function (e) {
            function t() {
                var t = (null !== e && e.apply(this, arguments)) || this;
                return (
                    (t.compileColGroupStats = pn(cc, fc)),
                    ...
                    (t.handleSizing = function (e, n) {
                        if (t.allowSizing()) {
                            ...
                            (e || (!n && !t.rowUnstableMap.size)) &&
                                (o.sectionRowMaxHeights =
                                    t.computeSectionRowMaxHeights()),
                                t.setState(
                                    r(
                                        r(
                                            {
                                                shrinkWidths:
                                                    t.computeShrinkWidths(),
                                            },
                                            t.computeScrollerDims()
                                        ),
                                        o
                                    ...
                                    function () {
                                        t.rowUnstableMap.size ||
                                            t.updateStickyScrolling();
                                    }
                                );
                        }
                    }),
            ...
            return (
                ...
                (t.prototype.render = function () {
                    var e = this,
                        ...
                        r = e.context,
                        i = n.shrinkWidths,
                        a = this.compileColGroupStats(
                            t.colGroups.map(function (e) {
                                return [e];
                            })
                        ),
                        s = this.renderMicroColGroups(
                            a.map(function (e, t) {
                                return [e.cols, i[t]];
                            })
                        ),
                    ...
                    return Yo(
                        "table",
                        { ref: t.elRef, role: "grid", className: l.join(" ") },
                        (function (e, t) {
                            var n = e.map(function (e, n) {
                                var r = e.width;
                                return (
                                    "shrink" === r &&
                                        (r = e.totalColWidth + vs(t[n]) + 1),
                                    Yo("col", { style: { width: r } })
                                );
                            });
                            return Yo.apply(void 0, o(["colgroup", {}], n));
                        })(a, i),
                        Boolean(!m && h.length) &&
                            Yo.apply(void 0, o(["thead", y], h)),
                        Boolean(!m && v.length) &&
                            Yo.apply(void 0, o(["tbody", y], v)),
                        Boolean(!m && g.length) &&
                            Yo.apply(void 0, o(["tfoot", y], g)),
                        m && Yo.apply(void 0, o(o(o(["tbody", y], h), v), g))
                    );
                }),
                ...
                (t.prototype.renderChunk = function (e, t, n, r, o, i, a, s) {
                    if ("outerContent" in o)
                        return Yo(Ko, { key: o.key }, o.outerContent);
                    var l = this.state,
                ...
                (t.prototype.componentDidMount = function () {
                    (this.getStickyScrolling = pn(gc, null, mc)),
                        (this.getScrollSyncersBySection = fn(
                            hc.bind(this, !0),
                            null,
                            vc
                        )),
                        (this.getScrollSyncersByColumn = fn(
                            hc.bind(this, !1),
                            null,
                            vc
                        )),
                    ...
                    this.updateScrollSyncers(),
                        this.handleSizing(
                            ...
                            t.sectionRowMaxHeights !==
                                this.state.sectionRowMaxHeights
                        );
                }),
                (t.prototype.componentWillUnmount = function () {
                    this.context.removeResizeHandler(this.handleSizing),
                ...
                (t.prototype.allowSizing = function () {
                    ...
                    return !this.lastSizingDate ||
                        e.valueOf() >
                            this.lastSizingDate.valueOf() +
                                Ta.SCROLLGRID_RESIZE_INTERVAL
                        ? ((this.lastSizingDate = e),
                    ...
                    for (
                        ...
                        if (a && a.syncRowHeights) {
                            for (var l = [], u = 0; u < r; u += 1) {
                                ...
                                (d = p
                                    ? He(p, ".fc-scrollgrid-sync-table tr").map(
                                          function (t) {
                                              var n = lc(t);
                                              return e.set(t, n), n;
                                          }
                            ...
                            for (u = 1; u < r; u += 1) {
                                if (
                                    !(
                                        a.chunks[u] &&
                                        void 0 !== a.chunks[u].outerContent
                                    ) &&
                                    l[u].length !== f
                                ) {
                                    h = !1;
                            ...
                            if (h) {
                                ...
                                for (
                                    var S = Math.max.apply(Math, y), u = 0;
                                    u < r;
                                    u += 1
                                ) {
                                    var E,
                ...
                (t.prototype.updateScrollSyncers = function () {
                    ...
                    (this.scrollSyncersBySection =
                        this.getScrollSyncersBySection(o)),
                        (this.scrollSyncersByColumn =
                            this.getScrollSyncersByColumn(i));
                }),
    ...
    var yc = ci({ deps: [Xu], scrollGridImpl: ac });
    ...
    var Sc = [],
        ...
        bc = ci({
            ...
            contextInit: function (e) {
                Sc.length ||
                    (window.addEventListener("beforeprint", Cc),
                    window.addEventListener("afterprint", Dc)),
                    Sc.push(e),
                    e.calendarApi.on("_unmount", function () {
                        ln(Sc, e),
                            Sc.length ||
                                (window.removeEventListener("beforeprint", Cc),
    ...
    function Cc() {
        for (
            var e = He(document.body, ".fc-scroller-harness > .fc-scroller"),
                t = e.map(function (e) {
    ...
    function Dc() {
        ...
        Qo(function () {
            for (; Ec.length; ) Ec.shift()();
        });
    }
    function Rc(e) {
        var t = e.getBoundingClientRect().width;
        (!e.classList.contains("fc-scrollgrid-collapsible") ||
            t < Ta.COLLAPSIBLE_WIDTH_THRESHOLD) &&
            (e.style.width = t + "px");
    }
    function wc(e) {
        e.style.width = "";
    ...
    function _c(e, t, n, r) {
        ...
        !(function (e, t, n) {
            ...
            if (e.labelInterval) {
                n.countDurationsBetween(r.start, r.end, e.labelInterval) >
                    Ta.MAX_TIMELINE_SLOTS &&
                    (console.warn(
                        "slotLabelInterval results in too many cells"
                    ),
            ...
            (function (e, t, n) {
                ...
                if (!o) {
                    ...
                    if (o)
                        n.countDurationsBetween(r.start, r.end, o) > 200 &&
                            (o = null);
        ...
        var u,
            c,
            d = n.snapDuration;
        d && ((u = qt(d)), (c = tn(o.slotDuration, u))),
            null == c && ((u = o.slotDuration), (c = 1)),
            (o.snapDuration = u),
            (o.snapsPerSlot = c);
        ...
        o.isTimeScale &&
            ((f = t.add(f, e.slotMinTime)),
            (h = t.add(ht(h, -1), e.slotMaxTime))),
            (o.timeWindowMs = p),
            (o.normalizedRange = { start: f, end: h });
        for (var v = [], g = f; g < h; )
            kc(g, o, e, r) && v.push(g), (g = t.add(g, o.slotDuration));
        o.slotDates = v;
        var m = -1,
            y = 0,
            S = [],
            E = [];
        for (g = f; g < h; )
            kc(g, o, e, r) ? ((m += 1), S.push(m), E.push(y)) : S.push(m + 0.5),
        ...
        return (
            ...
            (o.cellRows = (function (e, t) {
                for (
                    ...
                    for (
                        var u = n[l], c = e.isWeekStarts[l], d = 0;
                        d < r.length;
                        d += 1
                    ) {
                        var p = r[d],
    ...
    function xc(e, t, n) {
        ...
        return (
            t.isTimeScale ||
                ((r = bt(r)), t.largeUnit && (r = n.startOf(r, t.largeUnit))),
            r
        );
    }
    function kc(e, t, n, r) {
        ...
        return (
            ...
            (t.prototype.render = function () {
                var e = this,
                    ...
                    u = ["fc-timeline-slot", "fc-timeline-slot-label"].concat(
                        "time" === i.rowUnit ? To(l, n.theme) : wo(l, n.theme)
                    );
                        ...
                        return Yo(
                            ...
                            Yo(
                                "div",
                                {
                                    ...
                                    style: { height: t.rowInnerHeight },
                                },
                                Yo(Nc, {
                                    hookProps: c,
                                    isSticky: t.isSticky,
                                    navLinkAttrs: e.buildCellNavLinkAttrs(
                                        n,
                                        i.date,
                                        i.rowUnit
                                    ),
        ...
        Uc = (function () {
            ...
            return (
                ...
                (e.prototype.dateToCoord = function (e) {
                    ...
                    return this.isRtl
                        ? a.originClientRect.width -
                              (a.rights[r] - i.getWidth(r) * o)
    ...
    function Bc(e, t, n) {
        ...
        return ct(i) ? (i += r - o) : (i = Math.ceil(i)), i;
    }
    function zc(e, t) {
        return null === e
            ? { left: "", right: "" }
            ...
            return (
                ...
                (t.prototype.render = function () {
                    var e = this,
                        ...
                        o =
                            t.slatCoords &&
                            t.slatCoords.dateProfile === t.dateProfile
                                ? t.slatCoords
                                : null;
                    return Yo(Ga, { unit: r }, function (r, i) {
                        return Yo(
                            "div",
                            {
            ...
            return (
                ...
                (t.prototype.render = function () {
                    var e = this.props,
                        ...
                        p = r(r({ date: n.toDate(e.date) }, u), {
                            view: t.viewApi,
                        });
                    return (
                        l && c.push("fc-timeline-slot-em"),
                        s.isTimeScale &&
                            c.push(
                                ct(
        ...
        if (n)
            for (var o = 0, i = e; o < i.length; o++) {
                var a = i[o],
                    ...
                    u = Math.round(s.end);
                u - l < t && (u = l + t), r.push({ start: l, end: u });
            }
        return r;
    }
    var Zc = (function (e) {
            ...
            return (
                ...
                (t.prototype.sliceRange = function (e, t, n, r, o) {
                    var i = (function (e, t, n) {
                            if (!t.isTimeScale && ((e = or(e)), t.largeUnit)) {
                                var r = e;
                                ((e = {
                    ...
                    return Yo(
                        ...
                        function (t, n, o, a, s, u, p, f) {
                            return Yo(
                                ...
                                {
                                    ref: function (n) {
                                        li(t, n), li(i, n), li(e.rootElRef, n);
                                    },
                                ...
                                Yo(
                                    "div",
                                    {
                                        ref: o,
                                        className:
                                            "fc-timeline-more-link-inner fc-sticky",
                                    },
                                    a
                                )
                            );
            ...
            return (
                ...
                (t.prototype.render = function () {
                    var e = this,
                        ...
                        i = t.dateProfile,
                        a = t.tDateProfile,
                        s = this.slicer.sliceProps(
                            t,
                            i,
                            a.isTimeScale ? null : t.nextDayThreshold,
                            r,
                            i,
                        ...
                        l =
                            (s.eventDrag ? s.eventDrag.segs : null) ||
                            (s.eventResize ? s.eventResize.segs : null) ||
                            [],
                        ...
                        c = (function (e, t, n, r, o, i) {
                            for (
                                ...
                                c && d
                                    ...
                                    : s.push({ seg: u, hcoords: d, top: null });
                            }
                            var p = new fa();
                            ...
                            for (
                                ...
                                b.push({
                                    seg:
                                        T < e.length
                                            ? e[T]
                                            : v[T - e.length].entries.map(y),
                                    hcoords: w.span,
                                    top: w.levelCoord,
                                }),
                                    (C = Math.max(
                                        C,
                                        w.levelCoord + w.thickness
                                    ));
                            }
                            return [b.concat(s, h, m), C];
                        })(
                            u,
                            Yc(u, o.eventMinWidth, t.timelineCoords),
                        ...
                        f =
                            (s.eventDrag
                                ? s.eventDrag.affectedInstances
                                : null) ||
                            (s.eventResize
                                ? s.eventResize.affectedInstances
                                : null) ||
                            {};
                    return Yo(
                        Ko,
                        ...
                        Yo(
                            ...
                            this.renderFgSegs(
                                (function (e, t, n) {
                                    ...
                                    var r = (function (e) {
                                        for (
                                            ...
                                            Array.isArray(i) ||
                                                (t[
                                                    i.eventRange.instance.instanceId
                                                ] = o.top);
                                        }
                                        return t;
                                    })(n);
                                ...
                                })(l, t.timelineCoords, d),
                                {},
                                Boolean(s.eventDrag),
                                Boolean(s.eventResize),
                                !1
                            )
                        )
                    );
                ...
                (t.prototype.updateSize = function () {
                    ...
                    e.onHeightChange && e.onHeightChange(n, !1),
                        ...
                        e.syncParentMinHeight &&
                            (n.parentElement.style.minHeight = n.style.height);
                }),
    ...
    Qc.addStateEquality({ eventInstanceHeights: Wt, moreLinkHeights: Wt });
    var ed = (function (e) {
            function t() {
                var t = (null !== e && e.apply(this, arguments)) || this;
                return (
        ...
        td = (function (e) {
            function t() {
                var t = (null !== e && e.apply(this, arguments)) || this;
                return (
                    (t.buildTimelineDateProfile = cn(_c)),
                    (t.scrollGridRef = Xo()),
            ...
            return (
                ...
                (t.prototype.render = function () {
                    var e = this,
                        ...
                        s = !n.forPrint && Es(a),
                        l = !n.forPrint && bs(a),
                        u = this.buildTimelineDateProfile(
                            n.dateProfile,
                            i.dateEnv,
                            a,
                    ...
                    return (
                        l &&
                            f.push({
                                ...
                                key: "footer",
                                isSticky: !0,
                                chunks: [{ key: "timeline", content: Ss }],
                            }),
                        Yo(Ci, { viewSpec: i.viewSpec }, function (t, r) {
                            return Yo(
                                "div",
                                { ref: t, className: c.concat(r).join(" ") },
                                Yo(ac, {
                                    ref: e.scrollGridRef,
                                    liquid: !n.isHeightAuto && !n.forPrint,
                                    collapsibleWidth: !1,
    ...
    function od(e, t) {
        ...
        if (null == n) {
            ...
            r && (n = r.extendedProps.resourceEditable),
                null == n &&
                    null == (n = t.options.eventResourceEditable) &&
    ...
    function ad(e, t, n, o) {
        if (t) {
            var i = (function (e, t) {
                ...
                for (var r in e)
                    for (
                        var o = 0, i = t[e[r].defId].resourceIds;
                        o < i.length;
                        o++
                    ) {
                        n[i[o]] = !0;
    ...
    function gd(e, t, n) {
        ...
        if (!e || !t)
            return md(
                o.initialResources || o.resources,
                i.activeRange,
                o.refetchResourcesOnNavigate,
                n
            );
        switch (t.type) {
            case "RESET_RESOURCE_SOURCE":
                return md(
                    t.resourceSourceInput,
                    i.activeRange,
                    o.refetchResourcesOnNavigate,
                    n
                );
            ...
            case "CHANGE_VIEW_TYPE":
                return (function (e, t, n, r) {
                    if (
                        ...
                        (!e.fetchRange || !cr(e.fetchRange, t))
                    )
                        return yd(e, t, r);
                    return e;
            ...
            case "RECEIVE_RESOURCE_ERROR":
                return (function (e, t, n) {
                    if (t === e.latestFetchId)
                        return r(r({}, e), { isFetching: !1, fetchRange: n });
                    return e;
    ...
    function yd(e, t, n) {
        ...
        return (
            ...
            r(r({}, e), { isFetching: !0, latestFetchId: i })
        );
    }
    var Sd = "_fc:",
        Ed = {
    ...
    function Dd(e, t, n, o) {
        ...
        switch (t.type) {
            ...
            case "REMOVE_RESOURCE":
                return (function (e, t) {
                    var n = r({}, e);
                    for (var o in (delete n[t], n))
                        n[o].parentId === t &&
                            (n[o] = r(r({}, n[o]), { parentId: "" }));
                    return n;
                })(e, t.resourceId);
    ...
    var Rd = { resourceId: String, resourceIds: Wn, resourceEditable: Boolean };
    var wd = (function () {
        function e(e, t) {
        ...
        return (
            ...
            (e.prototype.getParent = function () {
                ...
                return n
                    ? new e(t, t.getCurrentData().resourceSource[n])
                    : null;
            }),
            ...
            (e.prototype.toPlainObject = function (e) {
                ...
                return (
                    ...
                    e.collapseEventColor &&
                    n.backgroundColor &&
                    n.backgroundColor === n.borderColor
                        ? (i.eventColor = n.backgroundColor)
                        : (n.backgroundColor &&
                              (i.eventBackgroundColor = n.backgroundColor),
                          n.borderColor &&
                              (i.eventBorderColor = n.borderColor)),
                    n.textColor && (i.eventTextColor = n.textColor),
                    n.classNames.length && (i.eventClassNames = n.classNames),
                    Object.keys(t.extendedProps).length &&
                        (e.collapseExtendedProps
                            ? r(i, t.extendedProps)
                            : (i.extendedProps = t.extendedProps)),
                    i
                );
            }),
            (e.prototype.toJSON = function () {
    ...
    (Yr.prototype.addResource = function (e, t) {
        ...
        e instanceof wd
            ? (((n = {})[(i = e._resource).id] = i), (o = n))
            : (i = bd(e, "", (o = {}), a)),
            this.dispatch({ type: "ADD_RESOURCE", resourceHash: o }),
            t && this.trigger("_scrollRequest", { resourceId: i.id });
        var s = new wd(a, i);
        return (
            a.emitter.trigger("resourceAdd", {
                resource: s,
                revert: function () {
                    r.dispatch({ type: "REMOVE_RESOURCE", resourceId: i.id });
                },
            }),
            s
        );
        ...
        (Yr.prototype.getResources = function () {
            var e = this.getCurrentData(),
                t = e.resourceStore,
                n = [];
            if (t) for (var r in t) n.push(new wd(e, t[r]));
            return n;
        }),
        (Yr.prototype.getTopLevelResources = function () {
            var e = this.getCurrentData(),
                t = e.resourceStore,
                n = [];
            if (t) for (var r in t) t[r].parentId || n.push(new wd(e, t[r]));
            return n;
        }),
    ...
    function _d(e, t) {
        return r(r({}, t), { constraints: xd(e, t.constraints) });
    }
    function xd(e, t) {
        ...
        (Zr.prototype.setResources = function (e) {
            for (var t = [], n = 0, r = e; n < r.length; n++) {
                ...
                "string" == typeof o
                    ...
                    : o instanceof wd
                    ? (i = o.id)
                    : console.warn("unknown resource type: " + o),
                    i && t.push(i);
            }
    ...
    var Od = (function (e) {
            ...
            return (
                ...
                (t.prototype.render = function () {
                    ...
                    return Yo(
                        Nd,
                        { resource: e.resource, date: e.date },
                        function (t, n, o, i, a) {
                            return Yo(
                                "th",
                                r(
        ...
        Ad = (function (e) {
            function t() {
                var t = (null !== e && e.apply(this, arguments)) || this;
                return (t.buildDateFormat = cn(Wd)), t;
            }
            return (
                n(t, e),
                (t.prototype.render = function () {
                    var e = this,
                        t = this.props,
                        n = this.context,
                        r = this.buildDateFormat(
                            n.options.dayHeaderFormat,
                            t.datesRepDistinctDays,
                            t.dates.length
                        );
                    return Yo(Ga, { unit: "day" }, function (o, i) {
                        return 1 === t.dates.length
                            ? e.renderResourceRow(t.resources, t.dates[0])
                            : n.options.datesAboveResources
                            ? e.renderDayAndResourceRows(
                                  t.dates,
                                  r,
                                  i,
                                  t.resources
                              )
                            : e.renderResourceAndDayRows(
                                  t.resources,
                                  t.dates,
                                  r,
                                  i
                ...
                (t.prototype.renderDayAndResourceRows = function (e, t, n, r) {
                    for (var o = [], i = [], a = 0, s = e; a < s.length; a++) {
                        var l = s[a];
                        o.push(
                            this.renderDateCell(l, t, n, r.length, null, !0)
                        );
                ...
                (t.prototype.renderDateCell = function (e, t, n, r, o, i) {
                    var a = this.props,
                        s = o ? ":" + o.id : "",
                        l = o ? { resource: new wd(this.context, o) } : {},
                        u = o ? { "data-resource-id": o.id } : {};
                    return a.datesRepDistinctDays
                        ? Yo(za, {
                              key: e.toISOString() + s,
                              date: e,
                              dateProfile: a.dateProfile,
                ...
                (t.prototype.buildTr = function (e, t) {
                    ...
                    return (
                        e.length || (e = [Yo("td", { key: 0 }, " ")]),
                        Yo("tr", { key: t, role: "row" }, n && n(t), e)
                    );
                }),
                t
            );
                    ...
                    for (
                        ...
                        for (var a = [], s = 0; s < n.colCnt; s += 1)
                            for (var l = 0; l < r.length; l += 1) {
                                var u = r[l],
                                    c = { resource: new wd(this.context, u) },
                                    d = { "data-resource-id": u.id },
                                    p = { resourceId: u.id },
                                    f = n.cells[i][s].date;
            ...
            return (
                ...
                (e.prototype.joinSegs = function (e) {
                    for (var t = [], n = 1; n < arguments.length; n++)
                        t[n - 1] = arguments[n];
                    for (
                        var r = e.resources.length, o = [], i = 0;
                        i < r;
                        i += 1
                    ) {
                        for (var a = 0, s = t[i]; a < s.length; a++) {
                ...
                (e.prototype.expandSegs = function (e, t) {
                    for (
                        var n = e.resources.length, r = [], o = 0;
                        o < n;
                        o += 1
                    )
                ...
                (e.prototype.joinInteractions = function (e) {
                    ...
                    return s
                        ? { affectedInstances: i, segs: a, isEvent: l }
                        : null;
                }),
                e
            );
            ...
            if (u)
                if (n) {
                    var c = t.length,
                        d = r.length;
                    if (
                        (Yd(l.children, t, n, r.concat(0), o, i, a),
                        c < t.length)
                    ) {
                        var p = t[c];
                    ...
                    var f =
                        null != i[(h = u.spec.field + ":" + u.value)]
                            ? i[h]
                            : a;
                    t.push({ id: h, group: u, isExpanded: f }),
        ...
        n.length && (-1 === o || r <= o)
            ? Zd(
                  ...
                  (function (e, t, n) {
                      ...
                      r ||
                          ((r = { group: { value: i, spec: n }, children: [] }),
                          t.splice(o, 0, r));
                      return r;
                  })(e, t, n[0]).children,
                  n.slice(1),
    ...
    function Xd(e, t, n) {
        ...
        for (r = 0; r < t.length; r += 1) {
            if (ot(t[r].resourceFields, e.resourceFields, n) > 0) break;
        }
        t.splice(r, 0, e);
    }
    function Kd(e) {
    ...
    var Jd = ci({
            ...
            isDraggableTransformers: [
                function (e, t, n, r) {
                    if (!e) {
                        ...
                        if (
                            o.viewSpecs[o.currentViewType].optionDefaults
                                .needsResourceData &&
                            od(t, r)
                        )
                            return !0;
                ...
                function (e, t, n) {
                    ...
                    if (r && od(e, n)) {
                        ...
                        if (-1 !== o) {
                            ...
                            i.splice(o, 1),
                                -1 === i.indexOf(r.setResourceId) &&
                                    i.push(r.setResourceId),
                                (e.resourceIds = i);
                        }
                    }
                },
            ...
            datePointTransforms: [
                function (e, t) {
                    return e.resourceId
                        ? {
                              resource: t.calendarApi.getResourceById(
                                  e.resourceId
                              ),
                          }
                        : {};
            ...
            isPropsValid: function (e, t) {
                ...
                for (var o in n) {
                    ...
                    if (
                        ...
                        !ts(i, t, { resourceId: o }, _d.bind(null, o)))
                    )
                        return !1;
                }
                return !0;
                ...
                resourceStore: function (e, t) {
                    ...
                    n.hasHandlers("resourcesSet") &&
                        n.trigger(
                            ...
                            (function (e, t) {
                                var n = [];
                                for (var r in e) n.push(new wd(t, e[r]));
                                return n;
                            })(e, t)
                        );
                },
        ...
        Qd = (function (e) {
            ...
            return (
                ...
                (t.prototype.transformSeg = function (e, t, n) {
                    return t
                        .computeColRanges(e.firstCol, e.lastCol, n)
                        .map(function (t) {
                            return r(r(r({}, e), t), {
            ...
            function t() {
                ...
                return (
                    ...
                    (t.isHitComboAllowed = function (e, n) {
                        return (
                            1 ===
                                t.props.resourceDayTableModel.dayTableModel
                                    .colCnt ||
                            e.dateSpan.resourceId === n.dateSpan.resourceId
                        );
                    }),
                    t
                );
            ...
            return (
                ...
                (t.prototype.render = function () {
                    var e = this,
                        ...
                        a = this.buildResourceDayTableModel(
                            t.dateProfile,
                            n.dateProfileGenerator,
                            i,
                            r.datesAboveResources,
                            n
                        ),
                        s =
                            r.dayHeaders &&
    ...
    var rp = ci({
        ...
        op = (function (e) {
            ...
            return (
                n(t, e),
                (t.prototype.transformSeg = function (e, t, n) {
                    return [r(r({}, e), { col: t.computeCol(e.col, n) })];
                }),
                t
            );
        })(Fd),
            ...
            return (
                ...
                (t.prototype.render = function () {
                    var e = this,
                        ...
                        l = (this.dayRanges = this.buildDayRanges(
                            s.dayTableModel,
                            a,
                            o
                        )),
                ...
                (t.prototype.buildNowIndicatorSegs = function (e) {
                    var t = this.slicers[""].sliceNowDate(
                        e,
                        this.context,
                        this.dayRanges
                    );
                    return this.joiner.expandSegs(
                        this.props.resourceDayTableModel,
                        t
                    );
                }),
                t
            ...
            return (
                ...
                (t.prototype.render = function () {
                    var e = this,
                        ...
                        c = this.buildResourceTimeColsModel(
                            a,
                            n.dateProfileGenerator,
                            u,
                            o.datesAboveResources,
                            n
                        ),
    ...
    function up(e) {
        for (
            ...
            a.push(Yo("span", { className: "fc-icon" }));
        var l = ["fc-icon"];
        return (
            n &&
                (r
                    ? l.push("fc-icon-minus-square")
                    : l.push("fc-icon-plus-square")),
            a.push(
                Yo(
                    "span",
                    {
                        className:
                            ...
                            (n ? "" : " fc-datagrid-expander-placeholder"),
                        onClick: i,
                    },
                    Yo("span", { className: l.join(" ") })
                )
            ),
            ...
            (t.prototype.render = function () {
                ...
                return Yo(
                    ...
                    function (e, t) {
                        return Yo(
                            "span",
                            { className: "fc-datagrid-cell-main", ref: e },
                            t
                        );
                    }
                );
    ...
    gp.addPropsEquality({ rowSpans: un });
    var mp = (function (e) {
        function t() {
            var t = (null !== e && e.apply(this, arguments)) || this;
            return (
        ...
        return (
            ...
            (t.prototype.render = function () {
                var e = this,
                    t = this.props,
                    n = this.context,
                    r = { groupValue: t.group.value, view: n.viewApi },
                    o = t.group.spec;
                return Yo(
                    "tr",
                    { role: "row" },
                            ...
                            return Yo(
                                "th",
                                {
                                    ...
                                    className: [
                                        "fc-datagrid-cell",
                                        "fc-resource-group",
                                        n.theme.getClass("tableCellShaded"),
                                    ]
                                        .concat(o)
                                        .join(" "),
                                },
    ...
    mp.addPropsEquality({ group: $d });
    var Sp = (function (e) {
            function t() {
                var t = (null !== e && e.apply(this, arguments)) || this;
                return (
                    (t.resizerElRefs = new ls(t._handleColResizerEl.bind(t))),
                    (t.colDraggings = {}),
                    t
                );
            }
            return (
                ...
                (t.prototype._handleColResizerEl = function (e, t) {
                    var n,
                        r = this.colDraggings;
                    e
                        ? (n = this.initColResizing(e, parseInt(t, 10))) &&
                          (r[t] = n)
                        : (n = r[t]) && (n.destroy(), delete r[t]);
                }),
                (t.prototype.initColResizing = function (e, t) {
                    ...
                    if (a) {
                        var s,
                            ...
                            u = new a(e);
                        return (
                            u.emitter.on("dragstart", function () {
                                var n = He(Pe(e, "tr"), "th");
                                (l = n.map(function (e) {
                                    return e.getBoundingClientRect().width;
                                })),
        ...
        Ep = (function (e) {
            ...
            return (
                ...
                (t.prototype.render = function () {
                    var e = this.props,
                        t = this.context,
                        n = { resource: new wd(t, e.resource) };
                    return Yo(
                        gi,
                        {
                            hookProps: n,
                ...
                return (
                    ...
                    (t.handleHeightChange = function (e, n) {
                        t.props.onHeightChange &&
                            t.props.onHeightChange(Pe(e, "tr"), n);
                    }),
                    t
                );
            }
            return (
                ...
                (t.prototype.render = function () {
                    var e = this,
                        ...
                        i = this.normalizeClassNames(
                            r.resourceLaneClassNames,
                            o
                        );
                    return Yo(
                        "tr",
    ...
    function Cp(e) {
        return { resource: new wd(e.context, e.resource) };
    }
    var Dp = (function (e) {
            function t() {
                return (null !== e && e.apply(this, arguments)) || this;
                        ...
                        e.rowNodes.map(function (i, a) {
                            ...
                            if (i.resource) {
                                ...
                                return Yo(
                                    bp,
                                    r(
                                        { key: i.id, elRef: n.createRef(i.id) },
                                        e.splitProps[s.id],
                                        {
                                            resource: s,
                                            dateProfile: e.dateProfile,
                                            ...
                                            todayRange: e.todayRange,
                                            nextDayThreshold:
                                                t.options.nextDayThreshold,
                                            businessHours:
                                                s.businessHours ||
                                                e.fallbackBusinessHours,
                                            innerHeight: o[a] || "",
        ...
        wp = (function (e) {
            function t() {
                var t = (null !== e && e.apply(this, arguments)) || this;
                return (t.rootElRef = Xo()), (t.rowElRefs = new ls()), t;
            }
            return (
                n(t, e),
                (t.prototype.render = function () {
    ...
    var Tp = (function (e) {
        function t() {
            var t = (null !== e && e.apply(this, arguments)) || this;
            return (
                (t.computeHasResourceBusinessHours = cn(_p)),
        ...
        return (
            ...
            (t.prototype.render = function () {
                var e = this,
                    ...
                    c = u[""],
                    d = this.bgSlicer.sliceProps(
                        c,
                        i,
                        a.isTimeScale ? null : n.nextDayThreshold,
                        o,
                        i,
                        o.dateProfileGenerator,
                        a,
                        o.dateEnv
                    ),
                    p =
                        r.slatCoords &&
                        r.slatCoords.dateProfile === n.dateProfile
                            ? r.slatCoords
                            : null;
                return Yo(
                    "div",
                    {
                        ...
                        className: [
                            "fc-timeline-body",
                            n.expandRows ? "fc-timeline-body-expandrows" : "",
                        ].join(" "),
                        style: { minWidth: n.tableMinWidth },
                    },
                    Yo(Ga, { unit: s }, function (t, r) {
                        return Yo(
                            Ko,
                            null,
                            Yo(qc, {
    ...
    var xp = (function (e) {
            ...
            return (
                    ...
                    a &&
                        s.push({
                            ...
                            chunks: [
                                ...
                                { key: "timeline", content: Ss },
                            ],
                        });
                    var l =
                        null != n.resourceAreaWidthOverride
                            ? n.resourceAreaWidthOverride
                            : o.resourceAreaWidth;
                    return Yo(ac, {
                        ...
                        collapsibleWidth: !1,
                        colGroups: [
                            { cols: t.spreadsheetCols, width: l },
                            { cols: [] },
                            { cols: t.timeCols },
                        ],
                        sections: s,
                ...
                (t.prototype.initSpreadsheetResizing = function () {
                    ...
                    if (r) {
                        var i,
                            ...
                            l = (this.spreadsheetResizerDragging = new r(
                                s,
                                ".fc-resource-timeline-divider"
                            ));
                ...
                (t.prototype.destroySpreadsheetResizing = function () {
                    this.spreadsheetResizerDragging &&
            ...
            function t(t, n) {
                ...
                return (
                    ...
                    (r.handleMaxCushionWidth = function (e) {
                        r.setState({ slotCushionMaxWidth: Math.ceil(e) });
                    }),
                    ...
                    (r.handleColWidthChange = function (e) {
                        r.setState({ spreadsheetColWidths: e });
                    }),
                    (r.state = {
            ...
            return (
                ...
                (t.prototype.render = function () {
                    var e = this,
                        ...
                        d = s.isVGrouping,
                        p = s.colSpecs,
                        f = this.buildTimelineDateProfile(
                            n.dateProfile,
                            o.dateEnv,
                            i,
                            o.dateProfileGenerator
                        ),
                        h = (this.rowNodes = this.buildRowNodes(
                            n.resourceStore,
                            u,
                            c,
                            d,
                            n.resourceEntityExpansions,
                    ...
                    return Yo(Ci, { viewSpec: a }, function (t, i) {
                        return Yo(
                            "div",
                            { ref: t, className: v.concat(i).join(" ") },
                            Yo(xp, {
                                ref: e.layoutRef,
                                forPrint: n.forPrint,
                ...
                (t.prototype.componentDidUpdate = function (e, t, n) {
                    (this.renderedRowNodes = this.rowNodes),
                        ...
                        n.resourceScroll &&
                            this.handleScrollRequest(n.resourceScroll);
                }),
                (t.prototype.componentWillUnmount = function () {
                    this.scrollResponder.detach();
                }),
                ...
                (t.prototype.queryResourceScroll = function () {
                    ...
                    if (e) {
                        for (
                            var n = this.layoutRef.current,
                                r = e.bottoms,
                                o = n.getResourceScroll(),
                                i = {},
                                a = 0;
                            a < r.length;
                            a += 1
    ...
    function Np(e) {
            ...
            c.group
                ? i.push(
                      r(r({}, c), {
                          cellClassNames:
                              c.cellClassNames ||
                              e.resourceGroupLabelClassNames,
                          cellContent:
                              c.cellContent || e.resourceGroupLabelContent,
                          cellDidMount:
                              c.cellDidMount || e.resourceGroupLabelDidMount,
                          cellWillUnmount:
                              c.cellWillUnmount ||
        ...
        if (
            ...
            (d.cellWillUnmount =
                d.cellWillUnmount || e.resourceLabelWillUnmount),
            i.length)
        )
            (a = i), (s = !0);
        else {
    ...
    kp.addStateEquality({ spreadsheetColWidths: un });
    var Hp = ci({
        deps: [Xu, Jd, rd],
    ...
    return (
        Ki.push(yl, Gl, xu, Lu, Bu, Vu, Gu, yc, bc, rd, Jd, rp, lp, Hp),
