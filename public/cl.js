...
var FullCalendar = (function (e) {
    ...
    (a.unmount = function (e) {
        ...
        (de.prototype.render = function (e, t) {
            ...
            return (
                o && (o.__h = null), [y(S, null, t.__a ? null : e.children), o]
            );
        });
            ...
            function t() {
                ...
                return (
                    ...
                    (t.handleRootEl = function (e) {
                        Qo(t.rootElRef, e),
                            t.props.elRef && Qo(t.props.elRef, e);
                    }),
                    t
                );
            }
            ...
            function (e) {
                return (function (e, t, n, o, i) {
                    ...
                    return {
                        ...
                        buttonTextDefault:
                            p(i) || e.defaults.buttonText || p(Dn) || e.type,
                        buttonTitleOverride:
                            f(o) || f(n) || e.overrides.buttonHint,
                        buttonTitleDefault:
                            f(i) || e.defaults.buttonHint || f(Dn),
                    };
                })(e, a, t, n, o);
            }
        );
        ...
        ti({
            ...
            propSetHandlers: {
                dateProfile: function (e, t) {
                    t.emitter.trigger(
                        "datesSet",
                        r(r({}, Rr(e.activeRange, t.dateEnv)), {
                            view: t.viewApi,
                        })
                    );
                },
                ...
                for (var f in a)
                    a[f] === u[f] || (_n[f] && _n[f](a[f], u[f]))
                        ...
                        : (a[f] === this.currentCalendarOptionsInput[f] ||
                          (_n[f] &&
                              _n[f](a[f], this.currentCalendarOptionsInput[f]))
            ...
            !(
                ...
                !(function (e, t, n, o) {
                    ...
                    for (var m in u) {
                        var y = u[m],
                            ...
                            S = c[y.defId],
                            b = l[y.defId];
                        if (!Ya(S.constraints, E, d, e.businessHours, t))
                            return !1;
                        ...
                        for (var w in f) {
                            var _ = f[w];
                            if (or(E, _.range)) {
                                if (!1 === h[_.defId].overlap && a.isEvent)
                                    return !1;
                                if (!1 === S.overlap) return !1;
                                if (
                                    C &&
                                    !C(
                                        new Fr(t, p[_.defId], _),
                                        new Fr(t, b, y)
                                    )
                                )
                                    return !1;
                ...
                !(
                    ...
                    !(function (e, t, n, o) {
                        ...
                        o && (c = o(c));
                        if (!Ya(c.constraints, u, i, e.businessHours, t))
                            return !1;
                        ...
                        for (var f in s) {
                            ...
                            if (or(u, h.range)) {
                                ...
                                if (p && !p(new Fr(t, a[h.defId], h), null))
                                    return !1;
                            }
                        }
                        for (var v = 0, g = c.allows; v < g.length; v++) {
                            if (!(0, g[v])(Mr(r(r({}, n), l), t), null))
                                return !1;
                        }
                        return !0;
                    })(e, t, n, o)
        ...
        return (
            ...
            (t.prototype.render = function () {
                ...
                return Uo(
                    ...
                    Boolean(!v && p.length) &&
                        Uo.apply(void 0, o(["thead", g], p)),
                    Boolean(!v && f.length) &&
                        Uo.apply(void 0, o(["tbody", g], f)),
                    Boolean(!v && h.length) &&
                        Uo.apply(void 0, o(["tfoot", g], h)),
            ...
            (t.prototype.computeShrinkWidth = function () {
                return ss(this.props.cols)
                    ? es(this.scrollerElRefs.getAll())
                    : 0;
            }),
    ...
    fs.addStateEquality({
        scrollerClientWidths: At,
        scrollerClientHeights: At,
    });
    var hs = (function (e) {
            function t() {
                var t = (null !== e && e.apply(this, arguments)) || this;
    ...
    var bs = (function (e) {
        function t() {
            var t = (null !== e && e.apply(this, arguments)) || this;
            return (
                (t.refineHookProps = an(Ss)), (t.normalizeClassNames = ci()), t
            );
        }
        return (
            n(t, e),
    ...
    function ws(e) {
        return (
            e.event.title &&
            Uo("div", { className: "fc-event-title" }, e.event.title)
        );
    }
    var _s = function (e) {
        return Uo(Yo.Consumer, null, function (t) {
            ...
            return (
                (e.prototype.destroy = function () {
                    this.containerEl.removeEventListener(
                        ...
                        (Ls -= 1) ||
                            window.removeEventListener("touchmove", Vs, {
                                passive: !1,
                            });
                }),
    ...
    function Ks(e, t) {
        return (
            (!e && !t) ||
            (Boolean(e) === Boolean(t) && _r(e.dateSpan, t.dateSpan))
        );
    }
    function $s(e, t) {
        for (
    ...
    var mu = (function (e) {
        function t() {
            var t = (null !== e && e.apply(this, arguments)) || this;
            return (
                (t.buildTimeColsModel = on(yu)), (t.buildSlatMetas = on(gu)), t
            );
        }
        return (
            n(t, e),
